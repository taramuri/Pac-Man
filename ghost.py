...
class Ghost:
    def __init__(self, x, y, target, speed, img, direction, dead, in_box, index, height, width, level, screen):
        self.x = x
        self.y = y
        self.target = target
        self.speed = speed
    ...
    def check_collisions(self):
        ...
        if 0 < self.center_x // 30 < 29:
            ...
            if self.direction == 0 or self.direction == 1:
                ...
                if 12 <= self.center_y % num1 <= 18:
                    if self.level[self.center_y // num1][(self.center_x - num3) // num2] < 3 \
                            or (self.center_xlevel[self.center_y // num1][(self.center_x - num3) // num2] == 9 and (
                            self.in_box or self.dead)):
                        self.turns[1] = True
                    if self.level[self.center_y // num1][(self.center_x + num3) // num2] < 3 \
                            or (self.level[self.center_y // num1][(self.center_x + num3) // num2] == 9 and (
